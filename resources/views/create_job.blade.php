...
<div class="mb-8">
    <h1 class="text-3xl font-bold text-gray-800">Buat Lowongan Baru</h1>
    <p class="text-gray-600 mt-1">Silahkan isi form dibawah ini untuk membuat lowongan baru.</p>
</div>
...
<div class="bg-white p-6 rounded-lg shadow-md">
    ...
    <form action="{{ route('jobs.store') }}" method="POST">
        ...
        <div class="flex items-center gap-5">
            ...
            <div class="mb-4 w-1/3">
                ...
                <input type="text" id="applicationPlatform" name="applicationPlatform"
                    class="w-full p-2 border rounded-md" value="{{ old('applicationPlatform') }}">
        ...
        <div class="mb-4">
            ...
            <textarea id="notes" name="notes" rows="4" class="w-full p-2 border rounded-md"></textarea>
        </div>
