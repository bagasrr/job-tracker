    ...
    return (
        <div className="bg-opacity-50 fixed inset-0 z-50 flex items-center justify-center bg-black backdrop-blur-sm">
            <div className="mx-auto flex max-w-sm flex-col items-center overflow-hidden rounded-lg border border-gray-200 bg-white p-6 shadow-xl dark:border-gray-700 dark:bg-gray-800">
                ...
                <p className="mt-2 text-center text-sm break-words text-gray-600 dark:text-gray-300">
                ...
                <div className="mt-6 flex w-full justify-end space-x-3">
                    ...
                    <button
                        type="button"
                        onClick={onConfirm}
                        className="rounded-md bg-rose-500 px-4 py-2 text-white transition-colors hover:bg-rose-600 dark:bg-rose-600 dark:hover:bg-rose-700"
                    >
                        Ya, Hapus
                    </button>
                </div>
